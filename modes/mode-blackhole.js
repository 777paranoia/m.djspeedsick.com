/* modes/mode-blackhole.js
   Registers the z3_bedroom and z3_alt_blackhole_walk GLSL modules used by
   Zone3Engine when route === 'z3b'. No separate engine class — Zone3Engine
   handles all rendering via this.isAltRoute checks.
*/

window.GLSL = window.GLSL || {};
window.GLSL.modules = window.GLSL.modules || {};

if (!GLSL.modules['z3_bedroom']) {
